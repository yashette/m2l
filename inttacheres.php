...
<html>
<head>	
	<title>Mes taches de responsable</title>
...
<body>
								...
								<!-- début formulaire pour la recherche -->
									...
									<div class="box">
								<form   method="post" >
									<a style='color:white;' href="intres.php">Retour en arrière</a><br/><br/>
...
{	
	...
	if($etat=="Affecte"||$etat=="en cours"||$etat=="en attente"||$etat=="terminée")  {	
			
		// recuperer les elements de la table demande
		$result = mysqli_query($mysqli, "SELECT * FROM demande Where etat='$etat' AND idresponsable='$id' ORDER BY numdemande DESC"); 
		?>	
	...
	?>
		...
		// recuperer les elements de la table demande
		$result = mysqli_query($mysqli, "SELECT * FROM demande WHERE idresponsable='$id' ORDER BY numdemande DESC"); 
